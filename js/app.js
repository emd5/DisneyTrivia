...
function userInput(){
    var dropdown, selectedDropDown, radio,
    //name
    x = document.getElementsByClassName("formPage");
    //dropdown
    dropdown = document.getElementById("distanceOption").selectedIndex;
    alert(document.getElementsByTagName("option")[dropdown].value);
}
